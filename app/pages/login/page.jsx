...
<section className="flex justify-center flex-col">
  <Image src={"/logo.png"} width={150} height={150} alt="madkammer logo" className="self-center h-auto w-auto"></Image>
    ...
    <button className=" w-32 mt-6 bg-forest text-white px-4 py-2 rounded-large font-bold m-auto flex self-center justify-center">
      Login
    </button>
</section>
